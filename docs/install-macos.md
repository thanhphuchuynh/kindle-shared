...
Release zips include the EPUB converter inside the app bundle. Users do not need to install boko separately.
...
- EPUB conversion is bundled in release zips via boko.
- boko is GPL-3.0-or-later. Its license is included in the app bundle at `KindleShare.app/Contents/Resources/Boko/LICENSE-GPL-3.0-or-later.txt`.
